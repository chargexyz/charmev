...
abstract class PeaqCodecApi {
  Future<Uint8List> getStorage({required String url, dynamic hint});
}
...
class PeaqCodecApiImpl extends FlutterRustBridgeBase<PeaqCodecApiWire>
  ...
  Future<Uint8List> getStorage({required String url, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) =>
            inner.wire_get_storage(port_, _api2wire_String(url)),
        parseSuccessData: _wire2api_ZeroCopyBuffer_Uint8List,
        constMeta: const FlutterRustBridgeTaskConstMeta(
          debugName: "get_storage",
          argNames: ["url"],
        ),
        argValues: [url],
        hint: hint,
...
class PeaqCodecApiWire implements FlutterRustBridgeWireBase {
  ...
  void wire_get_storage(
    int port_,
    ffi.Pointer<wire_uint_8_list> url,
  ) {
    return _wire_get_storage(
      port_,
      url,
    );
  }

  late final _wire_get_storagePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>('wire_get_storage');
  late final _wire_get_storage = _wire_get_storagePtr
